angular.module('activity')
  .controller('ActivityController', ['$scope', '$stateParams', '$modal',
    function($scope, $stateParams, $modal) {
      ...
      $scope.editRow = function(grid, row) {
        $modal.open({
          templateUrl: 'module/activity/view/edit-modal.html',
      ...
      $scope.gridOpts = {
        columnDefs: [{
          field: 'id',
          name: '',
          cellTemplate: 'module/activity/view/edit-button.html',
          width: 40
        }, {
          name: 'name'
        }, {
  ...
  .controller('ActivityListController', ['$scope', '$filter', '$stateParams', '$modal', '$http', 'uiGridConstants', function($scope, $filter, $stateParams, $modal, $http, uiGridConstants, $stateProvider, $urlRouterProvider, $compile, uiCalendarConfig) {
    'use strict';
    $scope.schema = {
      "type": "object",
      //"title": "Comment",
