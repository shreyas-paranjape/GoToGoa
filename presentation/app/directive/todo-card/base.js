angular.module('directives').controller('TodoCardController', ['$scope', 'Restangular', '$attrs', '$state',
...
angular.module('directives').directive('todocard',
    function () {
        return {
            restrict: 'EA',
            templateUrl: '/directive/todo-card/layout/todoCard.html',
