angular.module('directives').controller('DateCardController', ['$scope', 'Restangular', '$attrs', '$state',
...
angular.module('directives').directive('datecard',
    function () {
        return {
            restrict: 'EA',
            templateUrl: '/directive/date-card/layout/dateCard.html',
