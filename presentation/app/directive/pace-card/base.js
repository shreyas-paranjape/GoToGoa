angular.module('directives').controller('PaceCardController', ['$scope', 'Restangular', '$attrs', '$state',
...
angular.module('directives').directive('pacecard',
    function () {
        return {
            restrict: 'EA',
            templateUrl: '/directive/pace-card/layout/paceCard.html',
