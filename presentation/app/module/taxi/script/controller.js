angular.module('taxi')
    .controller('TaxiController', ['$scope', function ($scope) {
        'use strict';
        $scope.pageHeader = "taxi";
  }])
    .controller('TaxiDetailController', ['$scope', '$stateParams', function ($scope, $stateParams) {
        'use strict';
    ...
    .controller('TaxiListController', ['$scope', 'taxiRepository', '$filter', '$stateParams', '$timeout', '$log', 'leafletData', '$state',
    function ($scope, taxiRepository, $filter, $stateParams, $timeout, $log, leafletData, $state) {
            'use strict';
            $scope.showMap();
            $scope.slider = {
                min: 5000,
                ...
                angular.extend($scope, {
                    markers: {
                        m2: {
                            ...
                            lng: 73.9581,
                            focus: true,
                            message: "<div ng-controller='taxiListController' ng-include src=\"'module/taxi/view/template.html'\"></div>",
                            draggable: false
                        }
                    }
                });
