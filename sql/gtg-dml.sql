...
from
    organization
        inner join
    party ON organization.org_id = party.party_id
        inner join
    comm ON comm.comm_id = party.party_id
        inner join
    phy_add ON phy_add.phy_add_id = party.party_phy_add_id;
...
from
    facility
        inner join
    comm ON comm.comm_id = facility.fac_comm_id
        inner join
    phy_add ON phy_add.phy_add_id = facility.fac_phy_add;
